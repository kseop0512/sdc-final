            ...
            <div class="content">
                <form action="/updatePw.do" id="updatePwForm" method="post" autocomplete="off">
                    <div class="box" style="margin-bottom: 5px;">
                        ...
                        <input type="password" name="updatePw" id="memberPw" class="input" style="border-color: #ffc107;background-color:#1A1814;border-radius: 10px;margin-left: 60px;color: #fff;">
                    </div>
                    <div class="box" style="margin-bottom: 15px;">
                        <label for="memberPwChk">비밀번호 확인<span class="comment"></span></label>
                        <input type="password" name="memberPwChk" id="memberPwChk" class="input" style="border-color: #ffc107;background-color:#1A1814;border-radius: 10px;margin-left: 27px;color: #fff;">
                    </div>
                    <div class="btn-box">
