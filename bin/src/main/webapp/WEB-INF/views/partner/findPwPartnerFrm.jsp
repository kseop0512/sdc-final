            ...
            <div class="content">
                <form action="/findPwPartner.do" method="post" autocomplete="off">
                    ...
                    <div class="box" style="margin-bottom: 15px;">
                        ...
                        <input type="text" name="pPhone" id="pPhone" class="input shortInput" placeholder="-를 제외한 형식" style="border-color: #ffc107;background-color:#1A1814;border-radius: 10px;margin-left: 27px;color: #fff;">
