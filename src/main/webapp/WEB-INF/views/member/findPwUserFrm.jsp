            ...
            <div class="content">
                <form action="/findPwUser.do" method="post" autocomplete="off">
                    <div class="box" style="margin-bottom: 5px;">
                        ...
                        <input type="text" name="memberId" id="memberId" class="input" style="border-color: #ffc107;background-color:#1A1814;border-radius: 10px;margin-left: 31px;color: #fff;">
                    </div>
                    <div class="box" style="margin-bottom: 15px;">
                        <label for="memberPhone">전화번호<span class="comment"></span></label>
                        <input type="text" name="memberPhone" id="memberPhone" class="input shortInput" placeholder="-를 제외한 형식" style="border-color: #ffc107;background-color:#1A1814;border-radius: 10px;margin-left: 16px;color: #fff;">
                ...
                <div class="submit-btn" style="margin-left: 52px;margin-top: 5px;">
		            <a href="/loginUser.do" id="findIdBtn">로그인하러 가기</a>
		        </div>
            </div>
            <div class="resultDiv">
            </div>
