...
<body>
	<fieldset>
		...
		<form>
			...
			<input type="text" id="mId" placeholder="아이디 입력(6~10자)"><input type="button" value="중복 확인"><br>
			<label for="mPw">비밀번호</label><br>
			<input type="text" id="mPw" placeholder="비밀번호 입력(대소문자, 숫자, 특수문자를 포함한 10~20자)"><br>
			<label for="mPwRe">비밀번호확인</label><br>
			<input type="text" id="mPwRe" placeholder="비밀번호 재입력"><br>
			<label for="mName">이름</label><br>
			<input type="text" id="mName" placeholder=""><br>
