<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <head>
        ...
        <link href="/resources/css/partnerStyle.css" rel="stylesheet" />
    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="password.html">비밀번호 변경</a>
        ...
        <script src="/rescources/js/partnerScripts.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
        <script src="/resources/partnerAssets/chart-area-demo.js"></script>
        <script src="/resources/partnerAssets/chart-bar-demo.js"></script>
