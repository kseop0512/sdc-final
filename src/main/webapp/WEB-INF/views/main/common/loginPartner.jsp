...
<body>
  ...
  <section id="book-a-table" class="book-a-table section-bg1">
    <div class="container" data-aos="fade-up" id="loginBack">
      ...
      <form action="/loginPartner.do" method="post" role="form" data-aos="fade-up" data-aos-delay="100">
        <div class="row">
          <div class="col-lg-4 col-md-6 form-group">
            ID <input type="text" name="pId" class="form-control" id="pId" placeholder="Your ID" style="background-color: #0c0b09;border-color: #625b4b;color:#aaaaaa;"autocomplete="off">
          </div>
